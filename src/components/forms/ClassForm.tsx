        ...
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <div className="flex justify-between flex-wrap gap-4">
                ...
                <div className="flex flex-col gap-2 w-full md:w-1/4">
                    ...
                    <select className="ring-[1.5px] ring-gray-400 p-2 rounded-md text-sm w-full"
                        {...register("sex")}
                ...
                <div className="flex flex-col gap-2 w-full md:w-1/4 justify-center border-dashed border-2 p-4">

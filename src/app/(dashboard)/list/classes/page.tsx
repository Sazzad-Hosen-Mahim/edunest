...
const renderRow = (item: ClassList, role: string | undefined) => (
  ...
  >
    ...
    <td className="hidden md:table-cell py-4 px-2">{item.capacity}</td>
    <td className=" py-4 px-2">{item.name[0]}</td>
    <td className="hidden md:table-cell py-4 px-2">{item.supervisor.name + " " + item.supervisor.surname}</td>
    <td>
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      ...
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg fond-semibold">All Classes</h1>
